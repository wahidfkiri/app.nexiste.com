    ...
    <div>
      ...
      <div class="form-section" style="margin-bottom:0;">
        ...
        <div class="totals-panel">
          ...
          <div class="totals-row" id="exchange-rate-row" style="display:none;align-items:center;gap:10px;">
            <span class="totals-label">{{ $common['exchange_rate'] }}<br><small style="color:var(--c-ink-40);font-weight:400;">1 <span id="rateCur"></span> = {{ $tenantCurrency }}</small></span>
            <input type="number" name="exchange_rate" id="exchange_rate_input" value="1" min="0.000001" step="any" class="form-control" style="width:110px;text-align:right;">
          </div>
          <div class="totals-row grand-total" id="tot-base-equiv-row" style="display:none;">
            <span class="totals-label">{{ $common['equivalent_total'] }} {{ $tenantCurrency }}</span>
            <span class="totals-value" id="tot-base-equiv">0</span>
          </div>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Affiche le taux + l'équivalent dans la devise de base quand la devise diffère.
